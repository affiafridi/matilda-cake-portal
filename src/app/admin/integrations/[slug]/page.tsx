...
const META: Record<string, IntegrationMeta> = {
  ...
  "instagram": {
    name: "Instagram DM",
    desc: "Receive and reply to Instagram Direct Messages from the team inbox. Auto-reply with AI, assign conversations to agents, and handle customer enquiries from Instagram alongside WhatsApp.",
    category: "Messaging",
    iconBg: "bg-[#E1306C]/10",
    features: [
      "Receive Instagram DMs in the team inbox",
      "AI auto-reply for product queries and enquiries",
      "Assign Instagram conversations to agents",
      "Reply directly from the portal — no switching apps",
      "Separate Instagram tab in the inbox for easy navigation",
    ],
    icon: (
      <svg viewBox="0 0 24 24" fill="url(#ig-grad)" className="h-8 w-8">
        <defs>
...
const FIELDS: Record<string, Field[]> = {
  ...
  "instagram": [
    { key: "instagram_page_access_token", label: "Page Access Token", type: "password", hint: "Meta Developer → Instagram API → Generate token — long-lived token for your Instagram Business account" },
    { key: "instagram_verify_token",      label: "Webhook Verify Token", hint: "Any secret string you choose — must match what you entered in Meta webhook setup (e.g. matilda_ig_verify)" },
  ],
  "whatsapp-flows": [
