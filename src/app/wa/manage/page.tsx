          ...
          <>
            ...
            <div>
              ...
              <input type="url" value={btn.url}
                ...
                placeholder={btn.urlType === "DYNAMIC" ? "https://matildacake.com/order/{{1}}" : "https://matildacake.com"}
                className={inputCls} />
            </div>
            {btn.urlType === "DYNAMIC" && (
              <div>
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      <div>
                        ...
                        <input type="text" value={locationName} onChange={(e) => setLocationName(e.target.value)}
                          placeholder="Matilda Cakes — Downtown"
                          className="w-full rounded-lg border border-rule bg-canvas px-3 py-2 text-sm focus:border-[#25D366] focus:outline-none focus:ring-2 focus:ring-[#25D366]/20" />
                      </div>
                      <div>
            ...
            <div className="rounded-xl border border-rule bg-white">
              ...
              <div className="p-4 space-y-3">
                <textarea required rows={5} value={body} onChange={(e) => setBody(e.target.value)} maxLength={1024}
                  placeholder={"Hello {{1}}, your cake is ready for pickup!\n\nThank you for ordering from Matilda Cakes."}
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="relative">
              ...
              <input type="search" placeholder="Search…" value={search} onChange={(e) => setSearch(e.target.value)}
                className="w-40 rounded-lg border border-rule bg-white py-1.5 pl-8 pr-3 text-sm focus:border-[#c08a5b] focus:outline-none focus:ring-2 focus:ring-[#c08a5b]/20" />
            </div>
            {/* Refresh */}
            <button onClick={load}
