      ...
      <div className="overflow-hidden rounded-xl rounded-tl-sm bg-white border border-rule">
        ...
        {headerType === "IMAGE" && (
          headerMediaUrl && !imgFailed
            ? <img src={headerMediaUrl} alt="header" className="w-full object-contain bg-gray-100" style={{ maxHeight: "176px" }} // eslint-disable-line @next/next/no-img-element
          ...
          headerMediaUrl
            ? (
              <div className="relative bg-gray-900 cursor-pointer" onClick={toggleVideo}>
                <video ref={videoRef} src={headerMediaUrl} className="w-full object-contain" style={{ maxHeight: "176px" }} preload="metadata" muted playsInline
        ...
        <div className="overflow-hidden rounded-xl border border-rule">
          {isPdf ? (
            ...
            <div className="relative bg-black">
              <video src={previewSrc} className="w-full object-contain" style={{ maxHeight: "224px" }} controls muted playsInline />
            ...
            <div className="relative">
              ...
              <img src={previewSrc} alt="header preview" className="w-full object-contain bg-gray-100" style={{ maxHeight: "224px" }} />
